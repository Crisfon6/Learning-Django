    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_od_death', models.DateField(blank=True, null=True, verbose_name='Died')),
            ],
        ),
        migrations.CreateModel(
            name='Book',
            fields=[
                ...
                ('summary', models.TextField(help_text='Ingrese una brve description del libro', max_length=1000)),
